<?php
/**
 * File for ManualWW_WsdlClass to communicate with SOAP service
 * @package ManualWW_
 ...
 */
/**
 * ManualWW_WsdlClass to communicate with SOAP service
 * 
 * @package ManualWW_
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2015-09-25
 */
class ManualWW_WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://webapi.manualww.com/webapi_v2/WEB_Service.asmx?WSDL';
    /**
    ...
    /**
     * Constructor
     * @uses ManualWW_WsdlClass::setLastError()
     * @uses ManualWW_WsdlClass::initSoapClient()
     * @uses ManualWW_WsdlClass::initInternArrayToIterate()
     * @uses ManualWW_WsdlClass::_set()
     ...
     * @return ManualWW_WsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'ManualWW_WsdlClass'))
            {
     ...
     * @uses ManualWW_ClassMap::classMap()
     * @uses ManualWW_WsdlClass::getDefaultWsdlOptions()
     * @uses ManualWW_WsdlClass::getSoapClientClassName()
     * @uses ManualWW_WsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('ManualWW_ClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = ManualWW_ClassMap::classMap();
     ...
     * If a class is named as {ManualWW_}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('ManualWW_SoapClient') && is_subclass_of('ManualWW_SoapClient','SoapClient'))
            return 'ManualWW_SoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses ManualWW_WsdlClass::WSDL_CACHE_WSDL
     * @uses ManualWW_WsdlClass::WSDL_COMPRESSION
     * @uses ManualWW_WsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses ManualWW_WsdlClass::WSDL_ENCODING
     * @uses ManualWW_WsdlClass::WSDL_EXCEPTIONS
     * @uses ManualWW_WsdlClass::WSDL_FEATURES
     * @uses ManualWW_WsdlClass::WSDL_LOGIN
     * @uses ManualWW_WsdlClass::WSDL_PASSWORD
     * @uses ManualWW_WsdlClass::WSDL_SOAP_VERSION
     * @uses ManualWW_WsdlClass::WSDL_STREAM_CONTEXT
     * @uses ManualWW_WsdlClass::WSDL_TRACE
     * @uses ManualWW_WsdlClass::WSDL_TYPEMAP
     * @uses ManualWW_WsdlClass::WSDL_URL
     * @uses ManualWW_WsdlClass::VALUE_WSDL_URL
     * @uses ManualWW_WsdlClass::WSDL_USER_AGENT
     * @uses ManualWW_WsdlClass::WSDL_PROXY_HOST
     * @uses ManualWW_WsdlClass::WSDL_PROXY_PORT
     * @uses ManualWW_WsdlClass::WSDL_PROXY_LOGIN
     * @uses ManualWW_WsdlClass::WSDL_PROXY_PASSWORD
     * @uses ManualWW_WsdlClass::WSDL_LOCAL_CERT
     * @uses ManualWW_WsdlClass::WSDL_PASSPHRASE
     * @uses ManualWW_WsdlClass::WSDL_AUTHENTICATION
     * @uses ManualWW_WsdlClass::WSDL_SSL_METHOD
     ...
     * @uses ManualWW_WsdlClass::getSoapClient()
     * @uses ManualWW_WsdlClass::getFormatedXml()
     ...
     * @uses ManualWW_WsdlClass::getSoapClient()
     * @uses ManualWW_WsdlClass::convertStringHeadersToArray()
     ...
     * @uses ManualWW_WsdlClass::getInternArrayToIterate()
     * @uses ManualWW_WsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses ManualWW_WsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses ManualWW_WsdlClass::getInternArrayToIterateOffset()
     * @uses ManualWW_WsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses ManualWW_WsdlClass::getInternArrayToIterateOffset()
     * @uses ManualWW_WsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see ManualWW_WsdlClass::offsetGet()
     * @uses ManualWW_WsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses ManualWW_WsdlClass::getAttributeName()
     * @uses ManualWW_WsdlClass::__toString()
     * @uses ManualWW_WsdlClass::_set()
     * @uses ManualWW_WsdlClass::_get()
     * @uses ManualWW_WsdlClass::setInternArrayToIterate()
     * @uses ManualWW_WsdlClass::setInternArrayToIterateIsArray()
     * @uses ManualWW_WsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses ManualWW_WsdlClass::item()
     * @uses ManualWW_WsdlClass::length()
     * @return mixed
     */
