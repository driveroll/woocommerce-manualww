<?php
/**
 * File for class ManualWW_StructGetStatusByOrderId
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetStatusByOrderId originally named GetStatusByOrderId
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetStatusByOrderId extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $OrderID;
    /**
     * Constructor method for GetStatusByOrderId
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @param string $_orderID
     * @return ManualWW_StructGetStatusByOrderId
     */
