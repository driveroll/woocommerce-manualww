<?php
/**
 * File for class ManualWW_StructGetFreightByOrderID
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetFreightByOrderID originally named GetFreightByOrderID
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetFreightByOrderID extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $OrderID;
    /**
     * Constructor method for GetFreightByOrderID
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @param string $_orderID
     * @return ManualWW_StructGetFreightByOrderID
     */
