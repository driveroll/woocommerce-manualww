<?php
/**
 * File for class ManualWW_StructGetAllStatusByOrderID
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetAllStatusByOrderID originally named GetAllStatusByOrderID
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetAllStatusByOrderID extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $OrderID;
    /**
     * Constructor method for GetAllStatusByOrderID
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @param string $_orderID
     * @return ManualWW_StructGetAllStatusByOrderID
     */
