<?php
/**
 * File for class ManualWW_StructGetXmlReceivedOrdersList
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetXmlReceivedOrdersList originally named GetXmlReceivedOrdersList
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetXmlReceivedOrdersList extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $password;
    /**
     * Constructor method for GetXmlReceivedOrdersList
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @return ManualWW_StructGetXmlReceivedOrdersList
     */
