<?php
/**
 * File for class ManualWW_StructGetProductionOrdersList
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetProductionOrdersList originally named GetProductionOrdersList
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetProductionOrdersList extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $password;
    /**
     * Constructor method for GetProductionOrdersList
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @return ManualWW_StructGetProductionOrdersList
     */
