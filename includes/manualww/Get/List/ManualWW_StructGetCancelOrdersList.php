<?php
/**
 * File for class ManualWW_StructGetCancelOrdersList
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetCancelOrdersList originally named GetCancelOrdersList
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetCancelOrdersList extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $password;
    /**
     * Constructor method for GetCancelOrdersList
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @return ManualWW_StructGetCancelOrdersList
     */
