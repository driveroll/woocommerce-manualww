<?php
/**
 * File for class ManualWW_StructGetFreightByDateRangeOrders
 * @package ManualWW_
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ManualWW_StructGetFreightByDateRangeOrders originally named GetFreightByDateRangeOrders
 ...
 * @date 2015-09-25
 */
class ManualWW_StructGetFreightByDateRangeOrders extends ManualWW_WsdlClass
{
    /**
     * The venderName
     * Meta informations extracted from the WSDL
    ...
    public $enddate;
    /**
     * Constructor method for GetFreightByDateRangeOrders
     * @see parent::__construct()
     * @param string $_venderName
     * @param string $_password
     * @param string $_startdate
     * @param string $_enddate
     * @return ManualWW_StructGetFreightByDateRangeOrders
     */
